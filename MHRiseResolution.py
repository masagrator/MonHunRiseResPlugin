...
try:
    file = open("0100B04011742000\exefs\subsdk9.old", "rb")
except:
    try:
        file = open("0100B04011742000\exefs\subsdk9", "rb")
    except:
        print("No subsdk9 or subsdk9.old file in 0100B04011742000\exefs!");
        exit()
    file2 = open("0100B04011742000\exefs\subsdk9.old", "wb")
    temp = file.read()
    file2.write(temp)
    file2.close()
    file.close()
    ...
    file = open("0100B04011742000\exefs\subsdk9", "wb")
    file.write(temp)
    file.close()
    exit()
temp = file.read()
